# Bars - Musical Touch Interface

A responsive web-based musical instrument that transforms your screen into a playable 3x3 grid of bars. Each line plays a note from a configurable musical scale, creating an intuitive and accessible way to make music through touch, mouse, or keyboard.
...
### 2. **Play**: 
   - Touch or click the bars to play notes
   - Use keyboard keys (Z-X-C-V-B-N-M-,- .) for the 9 bars
   - Press 'P' key for panic stop (stops all notes)

![App Screenshot](docs/images/app-screenshot.png)

![Keyboard Layout](docs/images/keyboard-layout.png)
*Keyboard mapping for the 9 bars*
